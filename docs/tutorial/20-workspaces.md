# Lesson 20 — Filters and views: look at the part of the graph you mean
...
- a **filter** is one predicate, shown as a chip under the filter
  box — lesson 18's kind chips are filters, and so is `in core`,
...
*packages* chips (Lessons 21 and 30) — the **view chip** names what
...
[Lesson 21 — Branches: fork, edit, diff, merge](21-branches.md): a
