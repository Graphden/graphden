# Lesson 18 — Finding your way: kind filters and the Inspector
...
- Your filters are a per-browser preference; they survive reload
  ...
  **All functions** counts them (`2 filters`) — Lesson 20 makes it
  a named **view**.
...
Inspector are [lesson 17](17-errors-and-diagnostics.md)'s subject.
...
- **Runs** — this fn's own execution history, live. There is no
  ...
  row or node, and its history lands here (Lesson 13).
...
5. Reload the page — your chips stick, and the chip top-left counts
   them.
6. Build Lesson 17's duplicate pair (`tutorial-page-attrs` /
...
[Lesson 19 — Working without the mouse](19-keyboard-and-accessibility.md):
