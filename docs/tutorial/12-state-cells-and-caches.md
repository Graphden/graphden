# Lesson 12 — State: cells, swap, and a graph-native cache
...
`:swap` and `:reset` carry the `:state` effect (lesson 16): they
...
a load balancer (lesson 35's cardinality, [SCALING.md](../SCALING.md))
...
[lesson 13 — Recursion: loops without cycles](13-recursion.md)
