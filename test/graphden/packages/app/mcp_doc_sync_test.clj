(ns graphden.packages.app.mcp-doc-sync-test
  "The MCP ai-context resource reads
   `resources/packages/mcp/mcp/ai-context.md` off the classpath; that file
...
(deftest ai-context-doc-in-sync
  (let [doc (slurp (io/file "docs/AI_CONTEXT.md"))
        served (slurp (io/file "resources/packages/mcp/mcp/ai-context.md"))]
    (is (= doc served)
        "resources/packages/mcp/mcp/ai-context.md must equal docs/AI_CONTEXT.md — copy the doc over after editing it")))
