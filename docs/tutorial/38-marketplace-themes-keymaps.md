# Lesson 38 — The Marketplace: themes, keyboard layouts, and what others published
...
[Lesson 30](30-distributing-packages.md) left you with a registry: a
...
|---|---|---|
| **Packages** | fns-only packages published from a namespace | Install (a per-branch pin) or Fork (editable copies — [Lesson 30 § Fork](30-distributing-packages.md#fork--copy-on-write-when-you-want-to-edit) says when it refuses) — exactly Lesson 30's two doors |
...
> packages ship base-fns here?* An impl+fns package (Lesson 29) is
...
The ⬆ **publish** popover on a namespace row (Lesson 30) now has three
...
What if the package came from *another* graphden? Lesson 30's
...
navigation contract ([lesson 19](19-keyboard-and-accessibility.md)), not
...
6. **Reset to defaults** on the Keyboard pane, **Reset to built-in** on
   ...
   Lesson 30 if you want them gone).
...
[Lesson 39 — The package lifecycle](39-package-lifecycle.md): the loop
