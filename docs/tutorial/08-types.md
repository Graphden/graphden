# Lesson 08 — Types: atomic, refinement, record, union, variant, list
...
at runtime is [Lesson 09](09-higher-order-functions.md).

## `[:secret T]` — the security marker

Lesson 16 covers this in depth. Type-level marker that taints
...
[Lesson 20](20-explorer-and-inspector.md) and
...
[Lesson 09 — Higher-order functions](09-higher-order-functions.md)
