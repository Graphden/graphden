# Lesson 22 — Review: propose, approve, and the protected merge
...
> (no sign-up), or pick Lesson 22 in the editor's account menu.

This lesson builds on [Lesson 21](21-branches.md) — fork, edit, diff,
...
- **Push only via merge** — no direct writes at all; the only way in
  is a merge (lesson 21 covers this one).
...
- [Lesson 21](21-branches.md) — protected branches ("push only via
