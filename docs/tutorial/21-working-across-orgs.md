# Lesson 21 — Working across organizations
...
[Lesson 20 (Apps)](20-apps.md): apps live on `graphden.app`, and
...
This follows on from [Lesson 19 (Signing up & signing
in)](19-signing-up-and-in.md) — you have an account and an org.
...
sign in at and work from. It's the mirror image of Lesson 20: the
...
up for a new org ([Lesson 19](19-signing-up-and-in.md)) lands you
...
> again (signup only ever makes a *new* org — Lesson 19). Someone
> in the other org grants your account a capability in it
> ([Lesson 17 — Grants](17-grants.md)); membership is exactly
...
| `<label>.graphden.app` | one of the org's apps ([Lesson 20](20-apps.md)) |
...
This closes the domain model: [Lesson 20](20-apps.md) put your fns
