...
(async () => {
  ...
  console.log('edit-tutorial-tour — lessons 01 / 02 / 03 / 05 / 06 / 07 walked end-to-end');
  let failed = false;
  try {
    ...
    await setSealsViaBadge(page, 'nums', {'list-closed': true});
    ...
    await setSealsViaBadge(page, 'end', {terminal: true});
    ...
    await setSealsViaBadge(page, 'end', {terminal: false, required: true});
    await waitTourTitle(page, 'See it from the child', 150000);
