# Lesson 30 — Distributing packages: publish, install, update, fork
...
Lesson 29 was about **authoring** a package — the `fns.edn` /
...
| On disk (Lesson 29) | In the registry (this lesson) |
|---|---|
...
one fn, `:greet` (a namespace you make in the Explorer; Lesson 29's
...
(remember branches from [Lesson 21](21-branches.md) — pins are
...
(Lesson 29), those ids are the platform's own: the "copy" would land
...
[Lesson 39](39-package-lifecycle.md) walks end to end.
...
1. At the bottom of the Explorer click **New namespace** and type
   ...
   Lesson 29's on-disk package, `mycorp` already exists — publish its
...
5. **Fork** is the other door, and not one to open here: the copy
   ...
   [Lesson 39](39-package-lifecycle.md) plays that with two branches.
...
chip) — [lesson 38](38-marketplace-themes-keymaps.md).
...
([lesson 38](38-marketplace-themes-keymaps.md)).
...
[Lesson 29 § An external package from its own git repo](29-packages.md#an-external-package-from-its-own-git-repo).
...
[Lesson 31 — Working across organizations](31-working-across-orgs.md).
...
[Lesson 39](39-package-lifecycle.md).
