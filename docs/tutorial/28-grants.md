# Lesson 28 — Grants: who may touch what
...
([Lesson 29](29-roles.md)) instead of an email and the grant is
...
row is a **role** — the next lesson, [Lesson 29](29-roles.md).
...
1. Add `carol` to your org `acme` (Lesson 27).
...
3. Replace it with `write` on `acme` — now structural edits pass
   ...
   coverage).
4. Remove carol (Lesson 27) and watch her grant rows vanish with
...
[lesson 29 — Roles](29-roles.md): capabilities as a bundle.
