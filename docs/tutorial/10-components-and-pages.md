# Lesson 10 — Composing pages from components
...
its card ready to bind (extend in place, lesson 03). The same two
...
(Lesson 05); there is no hiccup literal anywhere with a label
...
hatch is [Lesson 11](11-custom-script-escape-hatch.md)'s.
...
Lessons 01–09 covered the graph model. This lesson turns it on
