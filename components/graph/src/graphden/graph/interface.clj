...
(defprotocol Graph
  ...
  (get-root-ancestor [this node-name]
    "Get the root ancestor of a node (top of inheritance chain)")

  (get-full-args [this node-name]
    "Get full args including inherited ones")

  (get-children [this node-name]
    "Get direct children of a node")

  (get-arg-refs [this node-name]
