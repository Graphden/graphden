# Lesson 16 — Effects and the `:secret` type-marker
...
`[:secret :text]` is a structural type (lesson 08). Its key
...
> refuse to execute (Lessons 04 / 08). Secret-flow violations are
