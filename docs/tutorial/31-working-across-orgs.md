# Lesson 31 — Working across organizations
...
[lesson 28 (Apps)](28-apps.md): apps live on `graphden.app`, and
...
Signing up and in is [lesson 34](34-signing-up-and-in.md), later in
...
sign in at and work from. It's the mirror image of Lesson 28: the
...
up for a new org ([Lesson 34](34-signing-up-and-in.md)) lands you
...
>   ([lesson 26 — Grants](26-grants.md)); membership is exactly
...
> account ([Lesson 34](34-signing-up-and-in.md)).
...
| `<label>.graphden.app` | one of the org's apps ([Lesson 28](28-apps.md)) |
...
This closes the domain model: [Lesson 28](28-apps.md) put your fns
