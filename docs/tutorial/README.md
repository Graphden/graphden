...
| 02 | Parents and inheritance — single parent, then multiple | ⏳ planned |
| 03 | Slots and bindings — what they are at the data level | ⏳ planned |
| 04 | Free arguments and how they propagate | ⏳ planned |
| 05 | Types — atomic, refinement, record, union, variant, list | ⏳ planned |
| 06 | Higher-order functions and `:fn`-typed slots | ⏳ planned |
| 07 | Effects and the `:secret` type-marker | ⏳ planned |
| 08 | Branches — fork, edit, diff, merge | ⏳ planned |
| 09 | Executing a fn — free-arg form, history, cancel | ⏳ planned |
| 10 | Services — long-running fns supervised by graphden | ⏳ planned |
| 11 | Packages — namespaces, fns.edn, impls.clj, deps | ⏳ planned |
