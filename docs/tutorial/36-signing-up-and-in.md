# Lesson 36 — Signing up & signing in: your account
...
- **Two-factor authentication** — enable TOTP: add the secret to
  ...
  *require* 2FA — [Lesson 28](28-grants.md) shows the
...
- **API tokens** — long-lived scoped keys for MCP/API clients
  ...
  [Lesson 42](42-ai-clients-and-api-tokens.md) walks minting one
...
capabilities — is [Lesson 27](27-users-admin.md) onward.
