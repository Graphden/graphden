# Lesson 33 — Working across organizations
...
[lesson 30 (Apps)](30-apps.md): apps live on `graphden.app`, and
...
Signing up and in is [lesson 36](36-signing-up-and-in.md), later in
...
sign in at and work from. It's the mirror image of Lesson 30: the
...
up for a new org ([Lesson 36](36-signing-up-and-in.md)) lands you
...
>   ([lesson 28 — Grants](28-grants.md)); membership is exactly
...
> account ([Lesson 36](36-signing-up-and-in.md)).
...
| `<label>.graphden.app` | one of the org's apps ([Lesson 30](30-apps.md)) |
...
This closes the domain model: [Lesson 30](30-apps.md) put your fns
