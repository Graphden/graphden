# Lesson 06 — Types: atomic, refinement, record, union, variant, list
...
at runtime is [Lesson 07](07-higher-order-functions.md).

## `[:secret T]` — the security marker

Lesson 14 covers this in depth. Type-level marker that taints
...
[Lesson 18](18-explorer-and-inspector.md) and
...
[Lesson 07 — Higher-order functions](07-higher-order-functions.md)
