...
// the canvas hosting the live code-facing lists (Errors / Type errors /
// Tests / Debug). These used to sit on the Organization surface, which hid
...
//   errors / type-errors — row counts of the loaded panel partials (they
