# Lesson 34 — Signing up & signing in: your account
...
chapter ([24 Members](25-users-admin.md), [25 Grants](26-grants.md))
and [34 Plans](35-plans-and-tiers.md), next, all assume the account
this lesson makes.
...
- **Two-factor authentication** — enable TOTP: add the secret to
  ...
  *require* 2FA — [Lesson 26](26-grants.md) shows the
...
- **API tokens** — long-lived scoped keys for MCP/API clients
  ...
  [Lesson 40](40-ai-clients-and-api-tokens.md) walks minting one
...
capabilities — is [Lesson 25](25-users-admin.md) onward.
