# Lesson 24 — Version history: what changed, and going back
...
Lesson 21 introduced branches; this is the other half of the same
...
version load underneath (lesson 13's history, sliced by version rather
