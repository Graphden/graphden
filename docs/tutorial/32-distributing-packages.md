# Lesson 32 — Distributing packages: publish, install, update, fork
...
Lesson 31 was about **authoring** a package — the `fns.edn` /
...
| On disk (Lesson 31) | In the registry (this lesson) |
|---|---|
...
one fn, `:greet` (a namespace you make in the Explorer; Lesson 31's
...
(remember branches from [Lesson 23](23-branches.md) — pins are
...
(Lesson 31), those ids are the platform's own: the "copy" would land
...
[Lesson 41](41-package-lifecycle.md) walks end to end.
...
1. At the bottom of the Explorer click **New namespace** and type
   ...
   Lesson 31's on-disk package, `mycorp` already exists — publish its
...
5. **Fork** is the other door, and not one to open here: the copy
   ...
   [Lesson 41](41-package-lifecycle.md) plays that with two branches.
...
chip) — [lesson 40](40-marketplace-themes-keymaps.md).
...
[Lesson 31 § An external package from its own git repo](31-packages.md#an-external-package-from-its-own-git-repo).
...
[Lesson 33 — Working across organizations](33-working-across-orgs.md).
...
[Lesson 41](41-package-lifecycle.md).
