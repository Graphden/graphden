# Lesson 30 — Apps: publishing a fn as a public site
...
response — see [Lesson 10 (Composing pages from
components)](10-components-and-pages.md), whose `:html-page` /
...
`:html-page` you rendered in Lesson 10, or a `:router` that
...
under the sidebar search (Lesson 20) narrows the tree to just
...
effect gate you met in [Lesson 16 (Effects and
secrets)](16-effects-and-secrets.md), now guarding the public
...
Next: [lesson 31 — Packages](31-packages.md). The flip side of the
domain model — where *your editor* lives when you belong to more
than one org — is [lesson 33](33-working-across-orgs.md).
